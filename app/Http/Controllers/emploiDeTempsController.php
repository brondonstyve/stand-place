...
//return $disponibilite;
        ...
        $passe = true;
        return view('administration/EDT', compact('resultat', 'resultat', 'test', 'testeur', 'passe', 'testeurEmpl', 'nombre', 'disponibilite', 'matiere', 'utilisateur', 'niveau', 'filiere', 'init', 'classe', 'remplisseur', 'classe'));
